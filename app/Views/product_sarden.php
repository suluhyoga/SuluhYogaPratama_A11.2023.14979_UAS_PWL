...
<div class="hero2">
    ...
    <?php endif; ?>
        ...
        <p class="content-top-isi">
            Berikut adalah berbagai pilihan sarden siap saji yang lezat dan bergizi untuk hidangan praktis keluarga.
            Tersedia dalam berbagai varian saus dan ukuran kemasan, sarden kami berasal dari merek terpercaya
            dengan kualitas rasa terbaik. Cocok untuk menu cepat saji yang tetap menggugah selera.
            Temukan sarden favorit Anda di sini.
        </p>
        ...
        <div class="content2-produkdetail">
            <div class="container-product">
                <?php if (!empty($product)) : ?>
                    ...
                    <?php endforeach; ?>
                <?php else : ?>
                    <p class="text-center">Tidak ada produk sarden yang ditemukan.</p>
                <?php endif; ?>
            </div>
        </div>
