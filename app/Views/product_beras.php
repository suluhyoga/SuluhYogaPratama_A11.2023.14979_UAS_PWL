...
<div class="hero2">
    <div class="content2">
        ...
        <p class="content-top-isi">
            Berikut adalah berbagai pilihan beras berkualitas untuk kebutuhan harian Anda. Mulai dari beras pandan wangi, beras merah sehat, hingga beras
                ketan putih untuk hidangan spesial. Semua produk kami dipilih dengan cermat untuk memastikan Anda mendapatkan yang terbaik. Temukan beras yang
                tepat untuk keluarga Anda dengan mudah di sini.
        </p>
        ...
        <div class="content2-produkdetail">
            <div class="container-product">
                <?php if (!empty($product)) : ?>
                    ...
                    <?php endforeach; ?>
                <?php else : ?>
                    <p class="text-center">Tidak ada produk beras yang ditemukan.</p>
                <?php endif; ?>
            </div>
        </div>
