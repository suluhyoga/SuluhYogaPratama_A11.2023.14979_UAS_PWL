...
<div class="hero2">
    <div class="content2">
        ...
        <p class="content-top-isi">
            Berikut adalah berbagai pilihan mie instan lezat untuk memanjakan lidah Anda. Dari mie instan rasa ayam pedas, mie goreng spesial,
                hingga mie instan sayur sehat, semua produk kami dirancang untuk memberikan cita rasa yang memuaskan dalam sekejap. Setiap varian dipilih
                dengan cermat untuk memastikan kualitas dan kenikmatan maksimal.
        </p>
        ...
        <div class="content2-produkdetail">
            <div class="container-product">
                <?php if (!empty($product)) : ?>
                    ...
                    <?php endforeach; ?>
                <?php else : ?>
                    <p class="text-center">Tidak ada produk mie instan yang ditemukan.</p>
                <?php endif; ?>
            </div>
        </div>
