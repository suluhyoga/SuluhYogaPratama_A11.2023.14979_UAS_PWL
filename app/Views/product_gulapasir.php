...
<div class="hero2">
    <div class="content2">
        ...
        <p class="content-top-isi">
            Kami menawarkan gula pasir pilihan yang sempurna untuk memenuhi kebutuhan memasak dan memanggang Anda. Dengan kualitas yang terjamin,
                gula pasir kami memberikan rasa manis yang alami dan konsisten, cocok untuk berbagai hidangan, mulai dari kue, minuman, hingga makanan sehari-hari.
                Produk kami dipilih dengan teliti untuk memastikan kelezatan dan kemurnian.
        </p>
        ...
        <div class="content2-produkdetail">
            <div class="container-product">
                <?php if (!empty($product)) : ?>
                    ...
                    <?php endforeach; ?>
                <?php else : ?>
                    <p class="text-center">Tidak ada produk gula pasir yang ditemukan.</p>
                <?php endif; ?>
            </div>
        </div>
